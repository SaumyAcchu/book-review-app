                            ...
                            <thead class="table-dark">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('review.myReview_edit',$reviewDa->id) }}" class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square"></i>
                                            </a>
...
<script>
    function deleteReview(id) {
        // alert(id);
        $.ajax({
            url:'{{ route('review.myReview_delete') }}',
            type:'delete',
            data:{id:id},
            headers: {
            ...
            success:function(response){
                //  alert(response.message);
                 window.location.href = '{{ route("review.myReview") }}';
            }
        })
    }
