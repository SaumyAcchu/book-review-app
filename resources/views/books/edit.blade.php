            ...
            <div class="card border-0 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('author') is-invalid @enderror" placeholder="Author"  name="author" id="author" value="{{ $book->author }}"/>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control @error('message') is-invalid @enderror"  name="image" id="image" value="{{ $book->image }}"/>
                            <span class="text-danger"> @error('image') {{ $message }} @enderror </span>
                            @if(!empty($book->image))
                                 <img src="{{ asset('uploads/books/thumb/'.$book->image) }}" class="w-25" alt="Luna John" >
                            @endif
                        </div>
